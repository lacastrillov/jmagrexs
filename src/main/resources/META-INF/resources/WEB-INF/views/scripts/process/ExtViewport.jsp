...
function ${entityName}ExtViewport(){
    ...
    Instance.defineFilters= function(){
            ...
            dockedItems: [{
                ...
                items: ['->',{
                    ...
                    handler: function(){
                        ...
                        Instance.entityExtController.doFilter(Instance.entityExtController.filter);
                    }
                }]
            }]
        });
        ...
        Instance.doFilter= function(){
            var filterData= Instance.filters.getForm().getValues();
            Instance.entityExtController.initFilter();
            var filter= Instance.entityExtController.filter;
            for(var fieldName in filterData){
