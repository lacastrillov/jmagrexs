...
public class CodeGenerator {
    ...
    public void setDataSource(String dataSource) {
        this.daoImplGenerator.setDataSource(dataSource);
    }
    ...
    public void setUnitName(String unitName) {
        this.daoImplGenerator.setUnitName(unitName);
    }
    ...
    public void setEntityServiceImpl(String entityServiceImpl) {
        this.serviceImplGenerator.setEntityServiceImpl(entityServiceImpl);
    }
