...
/**
 * Implementación de la clase GDGACBigqueryUtils.java
 *
 * Objecto que contiene funciones de ayuda para las otras clases..
 *
 ...
 *
 */
public class GDGACBigqueryUtils {

    /**
     * Contructor privada para evitar la creación de esta clase, que es
     * simplemente todo     * Métodos de ayuda estáticas.
     */
    protected GDGACBigqueryUtils() {

    }

    /**
     * Filas de impresión con la corriente de salida de una manera formateada..
     *
    ...
    /**
     * Objeto de trabajo para la terminación.
     *
     ...
     */
    // [START poll_job]
    public static Job getStatusJob(final Bigquery.Jobs.Get request, final long interval) throws IOException, InterruptedException {
     ...
     *
     * @param requestTemplate The object that represents the call to fetch the
     * results.
    ...
    public static <T extends GenericJson> Iterator<T> getPages(
        ...
        class PageIterator implements Iterator<T> {
             ...
             *
             * @param requestTemplate The object that represents the call to
             * fetch the results.
             */
