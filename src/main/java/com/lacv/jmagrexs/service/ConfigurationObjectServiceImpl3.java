...
import com.lacv.jmagrexs.interfaces.JsonObjectInterface;
 ...
 * @param <T>
 */
public abstract class ConfigurationObjectServiceImpl3<T> implements ConfigurationObjectService<T> {
    
    private final Class<T> coClass;
    
    protected final String TRANSACTION_MANAGER = "TRANSACTION_MANAGER_3";
    

    public ConfigurationObjectServiceImpl3() {
