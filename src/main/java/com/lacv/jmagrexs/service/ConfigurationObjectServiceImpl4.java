 ...
 * @param <T>
 */
public abstract class ConfigurationObjectServiceImpl4<T> implements ConfigurationObjectService<T> {
    
    private final Class<T> coClass;
    
    protected final String TRANSACTION_MANAGER = "TRANSACTION_MANAGER_4";
    

    public ConfigurationObjectServiceImpl4() {
