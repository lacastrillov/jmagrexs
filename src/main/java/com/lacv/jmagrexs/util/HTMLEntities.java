 ...
 * info@tecnick.com<br/>
 * Project homepage:
 * <a href="http://htmlentities.sourceforge.net" target="_blank">http://htmlentities.sourceforge.net</a><br/>
...
public class HTMLEntities {
     ...
     * [<a href="http://www.w3.org/TR/html401/sgml/entities.html" target="_blank">http://www.w3.org/TR/html401/sgml/entities.html</a>].
     */
    ...
    private static final Object[][] html_entities_basic_table = {
        {new String("&Aacute;"), new Integer(193)},
        {new String("&aacute;"), new Integer(225)},
        {new String("&acute;"), new Integer(180)},
        {new String("&Eacute;"), new Integer(201)},
    ...
    /**
     * Map to convert extended characters in html entities basic.
     */
    private static final Hashtable htmlentities_basic_map = new Hashtable();
    ...
    private static void initializeEntitiesTables() {
        ...
        // initialize html translation basic maps
        for (int i = 0; i < html_entities_basic_table.length; ++i) {
            htmlentities_basic_map.put(html_entities_basic_table[i][1],
                    html_entities_basic_table[i][0]);
        }
    }
    ...
    public static String basic(String str) {
        ...
        //initialize html translation maps table the first time is called
        if (htmlentities_basic_map.isEmpty()) {
            initializeEntitiesTables();
        }
        ...
        for (int i = 0; i < str.length(); ++i) {
            char ch = str.charAt(i);
            String entity = (String) htmlentities_basic_map.get(new Integer((int) ch)); //get equivalent html entity
            if (entity == null) { //if entity has not been found
                if (((int) ch) > 128) { //check if is an extended character
                    buf.append("&#" + ((int) ch) + ";"); //convert extended character
                } else {
